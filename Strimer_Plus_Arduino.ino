...
void setup() {
  ...
  Serial.print ("Strimer Plus Arduino|");
  Serial.print ("message:"); Serial.print (config.message); Serial.print ("|");
  Serial.print ("color:"); Serial.print (config.color); Serial.print ("|");
  Serial.print ("bg_color:"); Serial.print (config.bg_color); Serial.print ("|");
  Serial.print ("scrollDelay:"); Serial.print (config.scrollDelay); Serial.print ("|");
  Serial.print ("invert:"); Serial.print (config.invert); Serial.print ("|");
  Serial.print ("brightness:"); Serial.print (config.brightness); Serial.print ("\n");
